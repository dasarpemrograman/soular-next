...
-- =====================================================
-- This migration updates the get_user_favorites function to return
-- the correct field names (thumbnail and duration instead of
-- thumbnail_url and duration_minutes)
